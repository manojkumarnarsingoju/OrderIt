...
try{
    ...
    paymentData.description="Payment for Fooditem"
        ...
        <div className='col-10 col-lg-5'>
            <form className='shadow-lg' onSubmit={submitHandler}>
                ...
                <div className='form-group'>
                    ...
                    <CardNumberElement type="text" id='card_num_field' className='form-control' option={options}/>
                </div>
                <div className='form-group'>
                    <label htmlFor='card_exp_field'>Card Expiry</label>
                    <CardExpiryElement type="text" id='card_exp_field' className='form-control' option={options}/>
                </div>
                <div className='form-group'>
                    <label htmlFor='card_cvc_field'>Card CVC</label>
                    <CardCvcElement type="text" id='card_cvc_field' className='form-control' option={options}/>
                </div>
